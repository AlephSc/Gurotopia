...
void help(ENetEvent& event, const std::string_view text)
{
    ...
    helpText += (perper->role > 0) ? "`#Dou Zun commands:`` /punch /skin /ghost /find`w.``\n" : "";
    helpText += (perper->role > 1) ? "`8Ban Sheng commands:`` /weather /nick`w.``\n" : "";
    helpText += (perper->role > 2) ? "`4Dou Sheng commands:`` /ageworld`w.``\n" : "";
    helpText += (perper->role > 3) ? "`cDou Di commands:`` /edit`w.``" : "";
